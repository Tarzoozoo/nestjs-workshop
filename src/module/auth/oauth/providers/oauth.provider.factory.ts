...
// Factory to manage and provide OAuth providers (e.g., Google, Facebook, etc.)
// - To register multiple OAuth2 providers
// - To retrieve the appropriate provider based on the requested name
